namespace CryptoGramBot.Helpers
{
    ...
    {
        public static string BittrexBalanceInfo = "/trex_btc_balance";
        ...
        public static string PoloniexBalanceInfo = "/polo_btc_balance";
        public static string PoloniexTradeReset = "/polo_reset_trades";
    }
}